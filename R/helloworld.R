.onAttach <- function(...) {
  withr::with_preserve_seed({
    ...
    tips <- c(
      ...
      "Tip: 인공수정 시점은 배란은 발정종료 후에 일어나며 발정 시작부터 배란까지는 29-32시간으로서 발정종료후 8-11시간에 해당. 최초 관찰 후 12-18시간 사이에 인공수정 하는 것이 적절한 시점입니다.",
      "Tip: 이른 아침(오전 9시 전)에 발정징후를 발견한 소는 당일 오후가 수정적이기며, 오전 중(9-12시)에 발정징후를 발견한 소는 그날 저녁 또는 다음날 아침이 적기입니다. 발정징후를 오후에 발견한 경우에는 다음날 오전 중이 적기입니다.",
      "Tip: 발정암소의 외음부는 발정전기부터 차츰 붓기 시작하여 발정 최성기에 가장 많이 부어있고 발정 종료기에는 점차 가라앉게 됩니다.",
      "Tip: 암소의 발정전기에는 점액의 점조도가 높아졌다가 다시 낮아지나, 수정 적기에는 점도가 약간 증가하게 됩니다."
    )
